...
using PluginExasol.API.Discover;
using PluginExasol.API.Factory;
using PluginExasol.API.Read;
using PluginExasol.API.Replication;
using PluginExasol.API.Write;
using PluginExasol.DataContracts;
using PluginExasol.Helper;

namespace PluginExasol.Plugin
{
    public class Plugin : Publisher.PublisherBase
    {
        ...
        /// <summary>
        /// Establishes a connection with Exasol.
        /// </summary>
        /// <param name="request"></param>
        /// <param name="context"></param>
        ...
        /// <summary>
        /// Configures replication writebacks to Exasol
        /// </summary>
        /// <param name="request"></param>
        /// <param name="context"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Prepares writeback settings to write to Exasol
        /// </summary>
        /// <param name="request"></param>
        /// <param name="context"></param>
        /// <returns></returns>
            ...
            IServerStreamWriter<RecordAck> responseStream, ServerCallContext context)
        {
            try
            {
                Logger.Info("Writing records to Exasol...");
                ...
                Logger.Info($"Wrote {inCount} records to Exasol.");
            }
            catch (Exception e)
            {
                Logger.Error(e, e.Message, context);
